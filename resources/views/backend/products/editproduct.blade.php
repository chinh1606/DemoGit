                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  name="featured" class="form-control">
                                                <option {{$product['featured']?'':'selected'}} value="0">Không</option>
                                                <option {{$product['featured']?'selected':''}} value="1">Có</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Trạng thái</label>
                                            <select  name="state" class="form-control">
                                                <option {{$product["state"]?'selected':''}} value="1">Còn hàng</option>
                                                <option {{$product["state"]?'':'selected'}} value="0">Hết hàng</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <img id="avatar" class="thumbnail" width="100%" src="../uploads/{{$product['image']}}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">

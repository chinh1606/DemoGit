                    ...
                    <div class="col-12">
                        <div class="order-wrapper mt-50">
                            ...
                            <div class="order-list">
                                ...
                                <div class="list-row d-flex justify-content-between">
                                    <div class="col-md-4">Sản Phẩm {{++$count}} : {{$product["name"]}}</div>
                                    <div class="col-md-4" align='right'>x {{$product["quantity"]}}</div>
                                    <div class="col-md-4" align='right'>₫ {{$product["price"]*$product["quantity"]}}</div>
                                ...
                                <div class="list-row border-bottom-0 d-flex justify-content-between">
                                    ...
                                    <div class="col-md-4 offset-md-4" align='right'>₫ {{$order->total}}</div>
                                </div>
                            </div>
                        </div>
                    </div>

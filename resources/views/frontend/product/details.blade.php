                            ...
                            <form action="/gio-hang/them-hang/{{$product['id']}}" method="get">
                                ...
                                <div class="desc">
                                    ...
                                    <p style="text-align: justify;">
                                        VIETPRO STORE sẽ giao hàng tận nơi khi chọn mua sản phẩm: {{$product["info"]}}. Hoặc quí khách có thể đến tại địa chỉ shop có hiển thị bên dưới, khi chọn size phù hợp để xem và thử trực tiếp.
